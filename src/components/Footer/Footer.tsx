...
export function Footer(): ReactElement {
  ...
  return (
    <footer className="bg-white/90 dark:bg-black/90 backdrop-blur-md mt-8 p-4 py-6">
      <span className="text-muted text-xs">Copyright © {new Date().getFullYear()} Nutshell, todos os direitos reservados.</span>
      <div className="flex flex-col gap-4 w-full">
        ...
        <p className="text-muted text-xs text-justify leading-5 *:transition-all">
          ...
          <Link
            ...
            target="_blank"
            className="text-primary/30 hover:text-primary hover:underline underline-offset-2"
          >
            TailwindCSS
          </Link>
          ,{' '}
